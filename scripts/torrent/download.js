...
Request.prototype.send(message, onComplete){
...
function connectToTracker(tracker, infoHash, peerId){
    ...
    sock.on('message', function(msg){
        ...
        if(msgAction === action.CONNECT){
            ...
            var annMessage = announceMessage(Buffer.concat([toInt32(connectionId_upper), toInt32(connectionId_lower)]), infoHash, peerId);
