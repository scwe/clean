                ...
                <nav className="drag">
                    <div className="nav-wrapper blue-grey">
                        ...
                        <ul className="right hide-on-med-and-down no-drag">
                            <NavItem index={true} to="/"><i className='material-icons left'>file_download</i>Downloads</NavItem>
                        ...
                        <ul className="side-nav no-drag" id="mobile-demo">
                            <NavItem className="waves-effect" index={true} to="/"><i className='material-icons'>file_download</i>Downloads</NavItem>
